        ...
        <div className="dashboard-container">
            ...
            <main className="dashboard-main">
                <div className="profile-container">
                    ...
                    {/* Profile Hero */}
                    <div className="profile-hero" style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' }}>
                        <div className="avatar-section">
                            <div className="avatar-wrapper" onClick={handleAvatarClick}>
                                {user.image ? (
                                    ...
                                    <span className="avatar-initials" style={{ color: '#059669' }}>{getInitials(user.full_name)}</span>
                                )}
                        ...
                        <div className="profile-column">
                            ...
                            <div className="profile-details-grid">
                                <div className="info-card">
                                    <div className="info-icon-wrap" style={{ background: '#ecfdf5', color: '#10b981' }}>
                                        <User size={20} />
                                    </div>
                                ...
                                <div className="info-card">
                                    <div className="info-icon-wrap" style={{ background: '#f5f3ff', color: '#8b5cf6' }}>
                                        <Hash size={20} />
                                    </div>
                                    <div className="info-content">
                                        <span className="info-label">Mã số Giảng viên</span>
